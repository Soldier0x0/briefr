...
ext = [
    ...
    ("ext-rss", "6 RSS Feeds", "INCIDENT_RSS_SOURCES", "backend/feeds/incident_sources.py:3", "Six security news RSS/Atom feeds for Incidents tab.", "Headline feeds (Hacker News, Bleeping, Krebs, etc.).", ["line:3 — six sources in INCIDENT_RSS_SOURCES", "line:218 — fetch_all_incident_news_parallel"], ["incidents", "scheduler"]),
...
dbs = [
    ...
    ("db-corr", "correlation_*", "3-level correlation", "backend/database.py:233", "correlation_infrastructure, correlation_actor, correlation_temporal.", "Precomputed CVE correlation results.", ["line:416 — engine.run_nightly_correlation writes"], ["correlation"]),
