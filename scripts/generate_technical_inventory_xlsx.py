...
def main():
    ...
    for row in [
        ...
        ("Scheduler", "APScheduler", "3.11.2", "20+ background jobs"),
        ("Database", "PostgreSQL 16 + asyncpg", "—", "Production persistence (SQLite for pytest)"),
        ("Validation", "Pydantic", "2.13.4", "Request models"),
        ("UI", "React", "19.x", "Analyst SPA"),
        ("Build", "Vite", "8.x", "Dev and production bundle"),
