...
export function fetchCVEs(params = {}) {
  ...
  if (params.exclude_vendors) qs.set('exclude_vendors', params.exclude_vendors)
  if (params.severity_list) qs.set('severity_list', params.severity_list)
...
export const adminApi = {
  ...
  pingOutboundQueue: () => adminApi.postJson(outboundJobsPingPath(), {}),
}
