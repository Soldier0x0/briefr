...
| TBD | exploit-sources-batch2 | V1.3 T2-S4: PoC-in-GitHub (commit watermark), ExploitDB CSV, Metasploit metadata, Nuclei `cves.json` — scheduler `exploit_sources_sync`, additive `cve_exploits` + `has_poc`, fixture tests | 🔲 Open |
