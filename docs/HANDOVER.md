...
| #134 | brief-charts-ux-polish | V1.3 Theme 2 follow-up: urgency hierarchy (KEV accent bars, dim metadata), heatmap day labels, Chart.js theme tokens, remove 30d line chart, clickable KEV histogram (`onBucketClick`), EPSS movers table + sparklines, `CveDescriptionClamp` | 🔲 Open |
