...
| **UI (Track E)** | Drawer Intel: compact correlation infra table + styled controls (E-PR2); public exploits table, EPSS flat-line suppression, improved label contrast (E-PR3). |
