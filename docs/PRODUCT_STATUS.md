...
| **UI (Track E)** | Drawer Intel: compact correlation (E-PR2); exploits table + EPSS flat-line rule (E-PR3); **GreyNoise on-demand** with weekly quota UI — not auto on drawer open (E-PR4). |
