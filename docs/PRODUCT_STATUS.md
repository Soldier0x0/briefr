...
| **Incidents & News** | Five RSS sources (The Hacker News, Krebs on Security, Dark Reading, Schneier, CISA Advisories) + MITRE ATLAS via `GET /api/case-studies/feed`. Bleeping Computer removed from ingest. |
