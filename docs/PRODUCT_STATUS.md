...
| Correlation v3 Phase 0–1 (#473, #476, #487–#489): evidence-ranked peers, degree-penalized IOC hub confidence, severity/size removed from campaign confidence, additive `confidence_factors` in API + drawer | Correlation v3 Phase 2+ (PR-6…PR-13) — gated on `PG-001` (cross-file Postgres test pollution, BACKLOG §3) resolution first |
