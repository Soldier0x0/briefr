...
| **UI (Track E)** | Drawer Intel: compact correlation (E-PR2); exploits table + EPSS flat-line rule (E-PR3); **GreyNoise on-demand** with weekly quota UI — not auto on drawer open (E-PR4). BRIEF tab: E1 states audit complete (E-PR5). Header de-clutter + IST/EDT/PDT timezone labels with offset (E-PR6). |
