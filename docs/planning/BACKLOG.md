...
| **Detection composer** | Evidence-composed Sigma/KQL/SPL/QRadar/YARA (no LLM default); replace Forge keyword templates; shared drawer Detect + Forge | 🔶 DC-1/DC-2 shipped — DC-3…DC-4 open | [`specs/detection-composer-design.md`](specs/detection-composer-design.md) |
