...
| **Accent color** | **Keep** canonical tan `#c8b88a` (`--accent-selected`) — do **not** revert to pre-E8 orange; **apply consistently** (Phase 2). Maintainer may open a separate ADR if brand shift to brighter gold is desired. |
...
|---|----------|-------------------|
| Q1 | Revert accent to orange-red or keep tan gold? | Keep tan; enforce consistently (PM-2a) |
