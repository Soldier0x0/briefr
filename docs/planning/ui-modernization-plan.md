...
- [x] E3-4 Dialog/AlertDialog  [x] E3-5 Tabs/Dropdown/Select — #595  [x] E3-6 Slider — #596  [x] E3-7 Badge/Card/StatCard/EmptyState/Toast — #597
...
- [x] E7-1 hover/press  [x] E7-2 skeletons  [x] E7-3 copy/export feedback  [x] E7-4 spacing/borders  [x] E7-5 charts → Recharts (remove Chart.js)
- [x] E8-1 unify active — #598  [x] E8-2 breadcrumbs — #599  [x] E8-3 needs-attention landing — #600
