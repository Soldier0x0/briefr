...
**Status:** In progress — shipped items marked ✅; live execution state in [`../sessions/HANDOVER.md`](../sessions/HANDOVER.md)
...
For current architecture and data flows, see [`SYSTEM_DESIGN.md`](../../../SYSTEM_DESIGN.md). New contributors should start with [`docs/ONBOARDING.md`](../../ONBOARDING.md).

**Roadmap index:** [`docs/ROADMAP.md`](../../ROADMAP.md) — V1.3+ (analyst beast, admin, platform) are **out of scope** for V1.2 except items listed in [Allowed V1.2 additions](#allowed-v12-additions-from-planning-2026-06-10) below.
...
| Structured logging | ✅ Shipped — `structured_logging.py` JSON lines with `request_id`; `X-Request-ID` on every response; `briefr.access` per-request line (method/path/status/duration); `LOG_FORMAT=plain` opt-out |
...
| Document | Role |
|----------|------|
| [`docs/ROADMAP.md`](../../ROADMAP.md) | Master release index |
| [`docs/JUPITER_VISION.md`](../JUPITER_VISION.md) | Jupiter / BRIEFR north star |
| [`docs/OPERATIONS.md`](../../OPERATIONS.md) | Backup, logs, deploy compatibility |
| [`docs/THREAT_MODEL.md`](../THREAT_MODEL.md) | Application security model |
