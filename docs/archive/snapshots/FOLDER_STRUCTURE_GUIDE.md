...
| `docs/archive/snapshots/TECHNICAL_INVENTORY.md` | Stack, schema, scheduler, feature matrix |
| `TECHNICAL_INVENTORY.xlsx` | Spreadsheet export (generated on demand at repo root, not committed) |
| `docs/archive/snapshots/APPLICATION_EXECUTION_MAP.md` | Startup sequence and request journeys |
| `docs/archive/snapshots/CODEBASE_CONTEXT.md` | Consolidated codebase reference for AI assistants |
| `docs/archive/snapshots/FOLDER_STRUCTURE_GUIDE.md` | This file |
| `docs/planning/BACKLOG.md` | Open / parked work queue |
| `docs/planning/specs/` | Active program PR specs |
