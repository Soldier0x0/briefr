...
├── docs/archive/snapshots/     # Periodic AI/contributor snapshots (this folder)
│   ├── CODEBASE_CONTEXT.md
│   ├── FOLDER_STRUCTURE_GUIDE.md
│   ├── APPLICATION_EXECUTION_MAP.md
│   └── TECHNICAL_INVENTORY.md
├── docs/planning/              # Future work: BACKLOG.md + specs/
├── docs/archive/superseded/    # Shipped/replaced plans
