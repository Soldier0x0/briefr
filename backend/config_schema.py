...
CONFIG_SCHEMA: tuple[ConfigField, ...] = (
    ...
    ConfigField("GROQ_API_KEY", "api_keys", "secret",
                help_text="Primary LLM provider for PDF summaries and product extraction (Track K router)."),
    ConfigField("GEMINI_API_KEY", "api_keys", "secret",
                help_text="Gemini Flash-Lite failover for scheduler-side LLM tasks."),
