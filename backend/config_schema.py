...
CONFIG_SCHEMA: tuple[ConfigField, ...] = (
    ...
    ConfigField("DAILY_BRIEF_EOD_ENABLED", "scheduler_cron", "bool",
                help_text="Enable the end-of-day daily brief webhook job (default off).",
                display_label="Daily brief EOD"),
    ConfigField("DAILY_BRIEF_STANDUP_ENABLED", "scheduler_cron", "bool",
                help_text="Enable the morning standup daily brief webhook job (default off).",
                display_label="Daily brief standup"),
    ConfigField("DAILY_BRIEF_EOD_HOUR", "scheduler_cron", "int", min=0, max=23,
                help_text="Hour (0-23, SCHEDULER_TIMEZONE) the EOD daily brief runs.",
                display_label="Daily brief EOD hour", unit="h"),
    ConfigField("DAILY_BRIEF_EOD_MINUTE", "scheduler_cron", "int", min=0, max=59,
                help_text="Minute (0-59) the EOD daily brief runs.",
                display_label="Daily brief EOD minute", unit="min"),
    ConfigField("DAILY_BRIEF_STANDUP_HOUR", "scheduler_cron", "int", min=0, max=23,
                help_text="Hour (0-23, SCHEDULER_TIMEZONE) the standup daily brief runs.",
                display_label="Daily brief standup hour", unit="h"),
    ConfigField("DAILY_BRIEF_STANDUP_MINUTE", "scheduler_cron", "int", min=0, max=59,
                help_text="Minute (0-59) the standup daily brief runs.",
                display_label="Daily brief standup minute", unit="min"),
    ...
    ConfigField("LLM_PROVIDER_CUSTOM_ENABLED", "ml", "bool",
                display_label="Custom LLM enabled",
                help_text="Include the custom OpenAI-compatible slot in failover when its key is set. Disable without deleting the key."),
    ConfigField("LLM_PROVIDER_GROQ_ENABLED", "ml", "bool",
                display_label="Groq LLM enabled",
                help_text="Include Groq in scheduler LLM failover. Disable without deleting GROQ_API_KEY."),
    ConfigField("LLM_PROVIDER_CEREBRAS_ENABLED", "ml", "bool",
                display_label="Cerebras LLM enabled",
                help_text="Include Cerebras in scheduler LLM failover. Disable without deleting CEREBRAS_API_KEY."),
    ConfigField("LLM_PROVIDER_OPENROUTER_ENABLED", "ml", "bool",
                display_label="OpenRouter LLM enabled",
                help_text="Include OpenRouter in scheduler LLM failover. Disable without deleting OPENROUTER_API_KEY."),
    ConfigField("LLM_PROVIDER_GEMINI_ENABLED", "ml", "bool",
                display_label="Gemini LLM enabled",
                help_text="Include Gemini in scheduler LLM failover. Disable without deleting GEMINI_API_KEY."),
    ...
    ConfigField("DAILY_BRIEF_LLM_ENABLED", "ml", "bool",
                help_text="Optional LLM rewrite of the daily brief lede only (default off; template fallback).",
                display_label="Daily brief LLM lede"),
