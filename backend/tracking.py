...
API_LIMITS: dict[str, dict] = {
    ...
    "urlhaus": {
        ...
        "monthly_limit": None,
        "rate_limit": "Fair use · Auth-Key required",
        "notes": "Scheduled IOC catalog sync + one POST per domain/URL lookup. Same ABUSECH_AUTH_KEY as MalwareBazaar. IOC cache 6h.",
    ...
    "feodo": {
        ...
        "daily_limit": None,
        "monthly_limit": None,
        "rate_limit": "Public CC0 CSV",
        "notes": "Scheduled botnet C2 IP mirror (correlation; not blocklist export).",
    ...
    "phishtank": {
        ...
        "daily_limit": None,
        "monthly_limit": None,
        "rate_limit": "Community CSV · optional app key",
        "notes": "Scheduled verified-online phishing URL mirror for blocklist export.",
    ...
    "tranco": {
        ...
        "daily_limit": None,
        "monthly_limit": None,
        "rate_limit": "Daily ZIP download",
        "notes": "Top-1M legitimate-domain bulk import into infra classifications.",
